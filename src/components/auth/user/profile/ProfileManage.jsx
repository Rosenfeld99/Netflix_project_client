...
import { LANGUAGE, LANGUAGE_NETFLIX, MDX_PROFILEID } from "../../../../constant/url";
          ...
          <main className="grid min-h-screen place-items-center px-6 py-24 sm:py-32 lg:px-8">
            <div ref={ref} className="text-center">
              <h1
                ...
                className=" card-image mt-4 text-xl tracking-tight text-[#e3e2e2] sm:text-3xl"
              >
                {!hwoWatch ? (LANGUAGE_NETFLIX == "he" ? "ניהול פרופילים :" : "Manage Profiles :") : (LANGUAGE_NETFLIX == "he" ? "מי צופה ב-Netflix?" : "Hwo's Watching? ")}
              </h1>
              <div>
                <ScreenList
            ...
            {hwoWatch && (
              ...
              >
                {LANGUAGE == "he" ? "נהל פרופילים" : "Manage Profile"}
              </button>
            )}
            {!hwoWatch && (
              <button
