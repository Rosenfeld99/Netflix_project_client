...
const Notfication = () => {
  ...
  return (
    <Menu as="div" className="relative ml-3 ">
      ...
      <Transition className={`absolute ${LANGUAGE == "he" ? "sm:left-[400px] left-[335px]" : "sm:right-[400px] right-[335px]"} `}>
        <RiArrowUpSFill className={`text-2xl absolute ${LANGUAGE == "he" ? "right-[310px] sm:right-[375px]" : "left-[310px] sm:left-[375px]"}`} />
