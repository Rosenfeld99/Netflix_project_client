...
const Account = ({ classNames }) => {
  ...
  return (
    <Menu as="div" className="relative ml-3 ">
      ...
      <Transition className={`absolute ${LANGUAGE == "he" ? "left-56" : "right-56"}`}>
        <RiArrowUpSFill className={`text-2xl absolute ${LANGUAGE == "he" ? "right-[200px]" : "left-[200px]"}`} />
        <Menu.Items className="absolute border-[#605f5f3b] border-[1px] z-10 mt-4 w-56 bg-[#000000c3] py-1 shadow-lg text-center ">
              ...
              >
                <div className=" flex items-center">
                  <img
                    ...
                    alt=""
                  />
                  <p className=" mx-3 hover:underline"> {LANGUAGE == "he" ? "נהל פרופילים" : "Manage profile"} </p>
                </div>
              </Link>
            )}
          </Menu.Item>
          ...
          >
            <Menu.Item>
              <div>
                <p className=" mx-3 hover:underline ">{LANGUAGE == "he" ? "יציאה מ-Netflix" : "Sign out of Netflix"}</p>
              </div>
            </Menu.Item>
          </Menu.Items>
        </Menu.Items>
