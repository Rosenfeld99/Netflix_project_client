    ...
    <>
      {item?.backdrop_path && (
        <div
          ...
          className="relative">
          <div
            className={`w-full rounded-sm overflow-hidden cursor-pointer bg-[#212121] ${isHovered ? "active" : ""
              }`}
          ...
          >
            ...
            {isIntersecting ? (
              <img
                className="card-image w-full bg-[#212121]"
            ...
            {isHovered && (
              <div className="on-card-hover absolute inset-0 flex items-center justify-center z-50 w-full h-full">
                <div className=" in-on-card-hover rounded-md overflow-hidden bg-[#141414] mx-auto relative top-0 transform scale-y-0 origin-bottom shadow-[#00000063] shadow-md">
                  <div className="min-w-[220px] min-h-[110px] bg-[#212121] w-[20vw] h-[11vw]">
                    {isIntersecting ? (
                      <img
                        className="card-image w-full bg-[#212121]"
                        src={`https://image.tmdb.org/t/p/original${item.backdrop_path}`}
